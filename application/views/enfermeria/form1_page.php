...
<div id="formulario">
    ...
    <form class="row g-3" id="registro_actas">
        ...
        <div class="col-md-6">
            ...
            <small id="s_nombre_paciente" class="invalid-feedback">  </small>
        </div>
        <div class="col-md-6">
            <label for="enfermera_quirurjica" class="form-label">Enf. Quirúrgica</label>
            <input type="text" class="form-control" id="enfermera_quirurjica" name="enfermera_quirurjica">
            <small id="s_enfermera_quirurjica" class="invalid-feedback">  </small>
        </div>

        <div class="col-md-4">
            <label for="fecha_nacimiento" class="form-label">Fecha de nacimiento</label>
            <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento">
            <small id="s_fecha_nacimiento" class="invalid-feedback">  </small>
        </div>
        <div class="col-md-2">
            <label for="edad" class="form-label">Edad</label>
            <input type="number" class="form-control" id="edad" name="edad">
            <small id="s_edad" class="invalid-feedback">  </small>
        </div>
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <small id="s_cirujano" class="invalid-feedback">  </small>
        </div>
        ...
        <div class="col-md-6">
            ...
            <small id="s_anestesiologo" class="invalid-feedback">  </small>
        </div>

        <div hidden class="col-md-2">
            <label for="sala" class="form-label">Sala</label>
            <input type="text" class="form-control" id="sala" name="sala">
            <small id="s_sala" class="invalid-feedback">  </small>
        ...
        <div class="col-md-6" align="center"><br>
            <button href="<?=site_url('Enfermeria/Formulario2');?>" type="submit" class=" btn btn-primary" style="background-color: #00B4CC;">Siguiente</button>
        </div>
