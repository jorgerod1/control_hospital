...
<div id="cartas" >
    <div class="card" style="width: 20rem;" align="center" id="c1"><br>
        ...
        <div class="card-body">
            <img src="http://localhost/isw18/imagenes/toco-cirugia.png" class="card-img-top" alt="..."><br><br>
    ...
    <div class="card" style="width: 20rem;" align="center" style="background-color: #FBBAA4;" id="c2"><br>
        ...
        <div class="card-body">
            <img src="http://localhost/isw18/imagenes/cirugia.png" class="card-img-top" alt="..."><br><br>
    ...
    <div class="card" style="width: 20rem;" align="center" style="background-color: #FBBAA4;" id="c3"> <br>
        ...
        <div class="card-body">
            <img src="http://localhost/isw18/imagenes/equipo.png" class="card-img-top" alt="..."><br><br>
